...
//  OnTheMap
//
//  Created by Gizem Boskan on 21.06.2021.
//
...
class LoginViewController: UIViewController {
    ...
    private func login(){
        ...
        UdacitySessionClient.postSession(username: emailTextfield.text ?? "", password: passwordTextfield.text ?? "") { sessionResponse, error in
